...
sudo docker run -it -h shrinecentralhubDemo --name shrinecentralhubDemo --link mysqlshrinecentralhubDemoDB:mysql --link shrineqepDemo:shrineadapterDemo -p 8443:8443 -v ${INSTALL_PATH}/configs/shrinecentralhubDemo/:/shrine/ -d shrine:shrine
